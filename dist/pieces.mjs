...
export const pieceNames=['coral dots','blue waves','gold diagonal stripes','sage crosshatch','lavender checks','peach dashes','teal grid','crab: drain water to release','pufferfish: burst clears nearby pieces','jellyfish: sweep clears one pattern'];
const specials=[
